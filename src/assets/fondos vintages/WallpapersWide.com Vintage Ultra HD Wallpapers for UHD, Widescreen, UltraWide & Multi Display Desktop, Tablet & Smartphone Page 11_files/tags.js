...
if (e9Manager === undefined || e9Manager.init === false)
   ...
   e9Manager = (
	...
	e9Manager = manager;
        ...
        var e9Page = 
	 {
	   ...
	   tagOptions: {"snackBar":{"mobileOptimizedSite":false, "serveSnackBar":false, "snackBarBorder":false, "snackBarBorderColor":"", "snackBarClose":true}},
...
else
 {
   if (e9 !== undefined) 
    {
      e9Manager.setSite("wallpaperswidecom","snackbar");
